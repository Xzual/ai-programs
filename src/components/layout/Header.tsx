...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="relative top-0 z-20 flex min-h-[var(--edith-header-height)] shrink-0 flex-wrap items-center justify-between gap-2 border-b border-white/10 bg-slate-950/55 px-3 py-2 shadow-[inset_0_-1px_0_rgba(255,255,255,0.04)] backdrop-blur-2xl sm:px-4 xl:flex-nowrap xl:gap-3">
      {/* Left Title & Status */}
      <div className="flex min-w-[18rem] flex-1 flex-wrap items-center gap-2 overflow-visible xl:flex-nowrap xl:overflow-hidden">
        ...
        <div className="hidden min-w-[12rem] max-w-[clamp(12rem,16vw,17rem)] flex-1 items-center gap-2 rounded-md border border-white/10 bg-slate-950/54 px-2.5 py-1.5 text-[11px] font-mono text-slate-300 lg:flex">
        ...
        <div className="hidden min-w-[12rem] max-w-[clamp(12rem,18vw,18rem)] flex-1 items-center gap-2 rounded-md border border-white/10 bg-slate-950/54 px-2.5 py-1.5 text-[11px] font-mono text-slate-300 lg:flex">
        ...
        <div className="hidden min-[1920px]:flex items-center gap-2">
          <StatusPill
            label="Gemini"
