...
def _health_payload():
    ...
    return {
        ...
        "obsidian": obsidian_status.get("obsidian"),
        "obsidianEnabled": obsidian_exporter.enabled,
        "obsidianVaultPathConfigured": obsidian_status.get("vaultPathConfigured", obsidian_status.get("configured", False)),
        "obsidianExportStatus": obsidian_status.get("status"),
        "obsidianTargetPath": obsidian_status.get("resolvedPath") or obsidian_status.get("target_path"),
